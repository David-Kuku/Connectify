    ...
    return(
        <div>
            ...
            <div className="flex-child" style={{display:'flex', height:"25px"}}>
                ...
                <div>
                <p className="ml2 f6">Battery and Charging system</p>
                </div>
                <div>
                <p className='ml1'>
                        <i className='fa fa-angle-right f4'></i>
            ...
            <div style={{}}>
                <p>
                   <b style={{display:'flex'}} className='ml2 f5'>Sub Categories Under Automobile Diagonistics and Service Repairs:</b> 
                </p>
            </div>
            <div style={{height:'500px'}}>  
                <ul>
                <li>
                <p  style={{display:'flex', justifyContent:'flex-start'}}>Battery charging or replacement</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Alternator Charging or replacement</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Loose or worn out alternator belts</p></li>
