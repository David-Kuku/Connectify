    ...
    return(
        <div>
            ...
            <div className="flex-child" style={{display:'flex', height:"25px"}}>
                ...
                <div>
                <p className="ml2 f6">Brake system</p>
                </div>
                <div>
                <p className='ml1'>
                        <i className='fa fa-angle-right f4'></i>
            ...
            <div style={{paddingLeft:'0px'}}>
                <p style={{}}>
                   <b style={{display:'flex'}} className='ml2 f5'>Sub Categories Under Brake system :</b> 
                </p>
            </div>
            <div style={{height:'500px'}}>  
                <ul>
                <li>
                <p  style={{display:'flex', justifyContent:'flex-start'}}>Brake adjustment</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Anti-lock braking system(ABS) repairs</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Brake fluid replacement</p></li>
                </ul>
                </div>
        </div>
    )
