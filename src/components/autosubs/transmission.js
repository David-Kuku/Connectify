    ...
    return(
        <div>
            ...
            <div className="flex-child" style={{display:'flex', height:"25px"}}>
                ...
                <div>
                <p className="ml2 f6">Engine & Transmisson</p>
                </div>
                <div>
                <p className='ml1'>
                        <i className='fa fa-angle-right f4'></i>
            ...
            <div style={{}}>
                <p>
                   <b style={{display:'flex'}} className='ml2 f5'>Sub Categories Under Engine & Transmisson:</b> 
                </p>
            </div>
            <div style={{height:'500px'}}>  
                <ul>
                <li>
                <p  style={{display:'flex', justifyContent:'flex-start'}}>Engine repair or replacement</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Automatic repair or replacement</p></li>
