    ...
    return(
        <div>
            ...
            <div className="flex-child" style={{display:'flex', height:"25px"}}>
                ...
                <div>
                <p className="ml2 f6">Diagonistics</p>
                </div>
                <div>
                <p className='ml1'>
                        <i className='fa fa-angle-right f4'></i>
            ...
            <div style={{height:'500px'}}>  
                <ul>
                <li>
                <p  style={{display:'flex', justifyContent:'flex-start'}}>Dashboard Light</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Electrical Issues</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>Noises</p></li>
                <li><p  style={{display:'flex', justifyContent:'flex-start'}}>General problems </p></li>
